test_that("FDate sequencing", {
	...
	expect_equal(seq(as.FDate("2000-02-29"), 20000101L), as.FDate(character(0)))
	expect_equal(seq(as.FDate("2000-02-29"), 20000101L, from.last=T), as.FDate(character(0)))
	...
	expect_equal(seq.FDate("2000-12-31","2000-01-01",by="-1M"), as.FDate(c(20001231L, 20001130L, 20001031L, 20000930L, 20000831L, 20000731L, 20000630L, 20000531L, 20000430L, 20000331L, 20000229L, 20000131L)))
})
