...
test_that("FDate wcnt", {
	expect_equal(wcnt.FDate("2019-02-02"), as.wcnt("5A"))
	expect_equal(wcnt.FDate("2019-06-02"), as.wcnt("22S"))
	expect_equal(wcnt.FDate("2017-01-28"), as.wcnt("4A"))
	expect_equal(wcnt.FDate("2017-01-29"), as.wcnt("5S"))
	expect_equal(wcnt.FDate("2019-02-31"), wcnt.FDate("2019-02-28"))
	expect_equal(wcnt.FDate("2016-02-31"), wcnt.FDate("2016-02-29"))

	expect_equal(swcnt.FDate("2019-02-02"), as.wcnt("5A"))
	expect_equal(swcnt.FDate("2019-06-02"), as.wcnt("22S"))
	expect_equal(swcnt.FDate("2017-01-28"), as.wcnt("4A"))
	expect_equal(swcnt.FDate("2017-01-29"), as.wcnt("5S"))
	expect_equal(swcnt.FDate("2019-02-31"), wcnt.FDate("2019-02-28"))
	expect_equal(swcnt.FDate("2016-02-31"), wcnt.FDate("2016-02-29"))
	expect_equal(swcnt.FDate("2019-07-02"), mwcnt.FDate("2019-07-02"))
	expect_equal(swcnt.FDate("2019-09-30"), as.wcnt("14M"))

	expect_equal(qwcnt.FDate("2019-02-02"), as.wcnt("5A"))
	expect_equal(qwcnt.FDate("2019-06-02"), as.wcnt("9S"))
	expect_equal(qwcnt.FDate("2017-01-28"), as.wcnt("4A"))
	expect_equal(qwcnt.FDate("2017-01-29"), as.wcnt("5S"))
	expect_equal(qwcnt.FDate("2019-02-31"), wcnt.FDate("2019-02-28"))
	expect_equal(qwcnt.FDate("2016-02-31"), wcnt.FDate("2016-02-29"))
	expect_equal(qwcnt.FDate("2019-07-02"), mwcnt.FDate("2019-07-02"))
	expect_equal(qwcnt.FDate("2019-09-30"), as.wcnt("14M"))

	expect_equal(mwcnt.FDate("2019-02-02"), as.wcnt(1L,6L))
	expect_equal(mwcnt.FDate("2019-06-02"), as.wcnt("1S"))
	expect_equal(mwcnt.FDate("2019-06-03"), as.wcnt(1L, 1L))
})

test_that("FDate aux", {
	expect_equal(nyday("2000-A"), 366L)
	expect_equal(nyday("2001-S1"), 365L)
	expect_equal(nyday("2002-Q2"), 365L)
	expect_equal(nyday("2003-H"), 365L)
	expect_equal(nyday("2004-02-04"), 366L)

	expect_true(is.na(nsday("2000-A")))
	expect_equal(nsday("2001-S1"), 181L)
	expect_equal(nsday("2002-Q2"), 181L)
	expect_equal(nsday("2003-U"), 184L)
	expect_equal(nsday("2004-02-04"), 182L)
	expect_equal(nsday("2004-07-04"), 184L)

	expect_true(is.na(nqday("2000-A")))
	expect_true(is.na(nqday("2001-S1")))
	expect_equal(nqday("2002-Q2"), 91L)
	expect_equal(nqday("2003-H"), 90L)
	expect_equal(nqday("2004-02-04"), 91L)
	expect_equal(nqday("2002-Q4"), 92L)
	expect_equal(nqday("2004-Q3"), 92L)

	expect_true(is.na(nmday("2000-A")))
	expect_true(is.na(nmday("2001-S1")))
	expect_true(is.na(nmday("2002-Q2")))
	expect_equal(nmday("2003-H"), 31L)
	expect_equal(nmday("2004-02-04"), 29L)
	expect_equal(nmday("2004-Z"), 31L)
	expect_equal(nmday("2004-U"), 30L)
	expect_equal(nmday("2005-02"), 28L)
})
