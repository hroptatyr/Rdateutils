...
print("")
print(as.EDate("20140102"))
print(as.EDate("20140132"))
print(as.EDate("20141302"))
print(as.EDate("2010402"))
print(as.EDate(20140102L))
print(as.EDate(20140132L))
print(as.EDate(20141302L))
print(as.EDate(2010402L))
